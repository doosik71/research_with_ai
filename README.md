...
이 프로젝트의 생성 및 관리는
[RULES.md](RULES.md)의 규칙을 따른다.

`RULES.md`에는 다음과 같은 기준이 정의되어 있다.
...
- 연구 분야 목록은 [TOPICS.md](TOPICS.md)에 정리되어 있다.
- 자주 사용하는 프롬프트 예시는 [PROMPT.md](PROMPT.md)에 정리되어 있다.
- 작업 규칙과 문서 관리 기준은 [RULES.md](RULES.md)를 따른다.
...
1. [TOPICS.md](TOPICS.md)에서 연구 분야를 확인한다.
2. 해당 분야 폴더에서 논문 조사와 문서 작성을 진행한다.
3. 필요 시 [PROMPT.md](PROMPT.md)의 프롬프트 예시를 참고한다.
4. 모든 문서는 [RULES.md](RULES.md)의 형식과 절차를 따른다.

## 비고

이 프로젝트는 딥러닝 연구 분야를 장기적으로 축적 가능한 문서 자산으로
관리하는 것을 목표로 한다.
